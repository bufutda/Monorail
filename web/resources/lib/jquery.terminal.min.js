...
(function($, undefined) {
    ...
    */
    ...
    // -----------------------------------------------------------------------
    var version_set = true;
    $.terminal.version = "0.0.4";
    var copyright = 'Copyright &copy; 2016 Mitchell Sawatzky <http://sa.watz.ky>';
    var version_string = version_set ? ' v.' + $.terminal.version : ' ';
    //regex is for placing version string aligned to the right
    var reg = new RegExp(" {" + version_string.length + "}$");
    var name_ver = 'Zookin Web Service' +
        (version_set ? version_string : '');
    // -----------------------------------------------------------------------
    // :: Terminal Signatures
    // -----------------------------------------------------------------------
    var signatures = [
        ['Zookin Cipher Utility', '&copy; 2016 Mitchell Sawatzky'],
    ...
    $.fn.terminal = function(init_interpreter, options) {
        ...
        $.extend(self, $.omap({
            ...
            signature: function() {
                var cols = self.cols();
                var i = cols < 15 ? null : cols < 35 ? 0 : cols < 55 ? 1 : cols < 87 ? 2 : cols < 75 ? 3 : 4;
                if (i !== null) {
