 ...
 */
public class FirstStop extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.first_stop);

        responseView = (TextView)(findViewById(R.id.firstStopInfoTxt));
    ...
    public class BackgroundThread extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... urls)
        {
            ...
            try{
                URL url = new URL(MainActivity.API_URL + "/route/start?id=" + input);
