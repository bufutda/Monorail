 ...
 */
public class PreviousStop extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.previous_stop);

        responseView = (TextView)(findViewById(R.id.previousStopInfoTxt));
    ...
    public class BackgroundThread extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... urls)
        {
            ...
            try{
                URL url = new URL(MainActivity.API_URL + "/stop/prev?no=" + input);
