 ...
 */
public class VehicleTypesFromRoute extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.vehicle_types_from_route);

        responseView = (TextView)(findViewById(R.id.vehicleTypeTxt));
