 ...
 */
public class TypesFromStop extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.types_from_stop);

        responseView = (TextView)(findViewById(R.id.vehicleInfoTxt));
    ...
    public class BackgroundThread extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... urls)
        {
            ...
            try{
                URL url = new URL(MainActivity.API_URL + "/stop/vehicle?no=" + input);
