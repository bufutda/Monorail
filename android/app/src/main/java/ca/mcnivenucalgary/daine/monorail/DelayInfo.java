 ...
 */
public class DelayInfo extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        responseView = (TextView)(findViewById(R.id.delayInfoTxt));
    ...
    public class BackgroundThread extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... urls)
        {
            ...
            try{
                URL url = new URL(MainActivity.API_URL + "/delay/info?id=" + input);
