 ...
 */
public class NextStop extends AppCompatActivity
{
    ...
    public void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.nextt_stop);

        responseView = (TextView)(findViewById(R.id.nextStopInfoTxt));
    ...
    public class BackgroundThread extends AsyncTask<Void, Void, String>
    {
        ...
        protected String doInBackground(Void... urls)
        {
            ...
            try{
                URL url = new URL(MainActivity.API_URL + "/stop/next?no=" + input);
